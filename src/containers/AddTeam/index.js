...
function AddTeam(props) {
    ...
    const {firstLeagueToShow, tab, setTab, allBids, handleClaim, currentDate, activeYears, deadlines, dropTeam, handleAction, readyToRender, orgMembers, selectedMember, handleChange, currentRoster, sportTeams, league, setLeague, unownedTeams, currentOrganization} = useAddTeam()
    ...
    const getContent = (tab) => {
        switch(tab){
            ...
            case 'bids':
                return <CurrentBids currentOrganization={currentOrganization} allBids={allBids} sportTeams={sportTeams} />
        }
    }
